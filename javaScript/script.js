document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById("imagenZoom1").addEventListener("click", zoomImagen)
    document.getElementById("imagenZoom2").addEventListener("click", zoomImagen)
    // content_img.addEventListener('click', zoomImagen)
